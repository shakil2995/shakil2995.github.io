          ...
          {timeline.map((e, i) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`group relative overflow-hidden rounded-2xl border border-white/20 bg-[rgba(9,12,24,0.88)] p-5 shadow-xl backdrop-blur-md transition-all duration-300 sm:p-6 ${styles.border} ${styles.glow} hover:-translate-y-0.5 hover:bg-[rgba(14,18,36,0.95)]`}
                >
